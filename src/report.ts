...
<body>
<main>
<header><div><h1>Pi Emotion Trace</h1><div class="subtitle">Emotional valence and interaction signals across chronological prompts</div></div><div class="muted">${first ? `${escapeHtml(formatTimestamp(first))} — ${escapeHtml(formatTimestamp(last!))}` : "No prompts"}</div></header>
